                ...
                <div className="recent-transaction">
                  <div className="row">
                    ...
                    <div className="islem">
                      ...
                      <span style={{ color: "#718EBF" }}>28 January 2021</span>
                    </div>
                  ...
                  <div className="row">
                    ...
                    <div className="islem">
                      <span style={{ fontWeight: "500" }}>Deposit Paypal</span>
                      <span style={{ color: "#718EBF" }}>25 January 2021</span>
                    </div>
                    <div className="amount">
                  ...
                  <div className="row">
                    ...
                    <div className="islem">
                      ...
                      <span style={{ color: "#718EBF" }}>21 January 2021</span>
                    </div>
                    <div className="amount">
